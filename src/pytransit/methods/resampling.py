...
class Method:
    ...
    def define_panel(self, _):
        ...
        with panel_helpers.NewPanel() as (panel, main_sizer):
            ...
            self.value_getters.LOESS                  = panel_helpers.create_check_box_getter(panel, main_sizer, label_text="LOESS Correction", default_value=False, tooltip_text="Perform LOESS Correction")
