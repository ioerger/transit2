...
"""
    ...
    def Run(self):
        ...
        if cmd=="extract_counts":
            ...
            self.extract_abund(combined_counts_file,metadata_file,control_condition,sgRNA_strength_file,no_dep_abund,drug,days, fractional_abundance_file)
        elif cmd == "run_model":
            if len(args)<1: 
                print("You have provided incorrect number of args")
                print(self.usage_string())
            ...
            self.visualize(frac_abund_file, gene, fig_location, fixed = fixed_axes, origx = origx_axis, origy=origy_axis)
