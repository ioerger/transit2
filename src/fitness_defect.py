...
print "# noness: zeros=%s, NZmean=%0.1f" % (
    noness_NZvals.size,
    numpy.mean(noness_NZvals),
)
...
print "\t".join(
    "ORF gene start end strand TAs sum mean sat NZsites NZmean expec_sum FC LFC pval qval".split()
)
for vals in results:
