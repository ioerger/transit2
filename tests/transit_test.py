...
ctrl_rep1 = basedir + "/../src/pytransit/data/cholesterol_glycerol.transit/glycerol_rep1.wig"
ctrl_rep2 = basedir + "/../src/pytransit/data/cholesterol_glycerol.transit/glycerol_rep2.wig"
ctrl_data_txt = ",".join([ctrl_rep1, ctrl_rep2])
mini_wig = basedir + "/data/test.wig"

combined_wig = basedir + "/../src/pytransit/data/cholesterol_glycerol.transit/comwig.tsv"
samples_metadata = basedir + "/../src/pytransit/data/cholesterol_glycerol.transit/metadata.tsv"
samples_metadata_covariates = basedir + "/../src/pytransit/data/cholesterol_glycerol.transit/metadata.covar.tsv"
samples_metadata_interactions = basedir + "/../src/pytransit/data/cholesterol_glycerol.transit/metadata.interactions.tsv"

KO_combined_wig = basedir + "/../src/pytransit/data/subu_ko.transit/comwig.tsv"
KO_samples_metadata = basedir + "/../src/pytransit/data/subu_ko.transit/metadata.tsv"

exp_rep1 = basedir + "/../src/pytransit/data/cholesterol_glycerol.transit/cholesterol_rep1.wig"
exp_rep2 = basedir + "/../src/pytransit/data/cholesterol_glycerol.transit/cholesterol_rep2.wig"
exp_rep3 = basedir + "/../src/pytransit/data/cholesterol_glycerol.transit/cholesterol_rep3.wig"
